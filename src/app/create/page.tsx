...
import CollectionDropdown2 from "@/components/dropdown/CollectionDropdown2";
          ...
          <div className="mx-auto max-w-[48.125rem]">
            ...
            <div className="mb-6">
              ...
              {fileName ? (
                ...
                <p className="dark:text-jacarta-300 text-2xs mb-3">
                  Drag or choose your fileName to upload
                </p>
              )}

              <label className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 group relative flex max-w-md flex-col items-center justify-center rounded-lg border-2 border-dashed bg-white py-20 px-5 text-center">
            ...
            <div className="mb-6">
              ...
              <div className="dropdown relative mb-4 cursor-pointer ">
                <CollectionDropdown2 data={EthereumDropdown2_data} />
              </div>
            </div>
