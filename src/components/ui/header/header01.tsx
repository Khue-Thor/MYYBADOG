...
export default function Header01() {
  ...
  const nft = ["Bored Ape Nike Club", "Dragon Stinky", "The King of Kind", "Ape the knight", "Drinking bady", "Bored Ape Yacht Club"]
  ...
  const handleFilter = async (e) => {
    ...
    const newFilter = contracts.filter((value) => {
        ...
        <div className="flex items-center px-3 py-2 xl:px-24 ">
          ...
          >
            ...
            {filteredData.length !== 0 && (
              <div className="scroll bg-white text-black -z-1 absolute left-[0px] top-[60px] pt-3 pb-[20px] w-full sm:w-[400px] rounded-3xl flex flex-col gap-1 pr-[10px] pl-[10px]">
