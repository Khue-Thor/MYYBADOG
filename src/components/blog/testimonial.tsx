...
const Testimonial = ({ bgWhite }: TestimonialProps) => {
  return (
        ...
        <div className="flex flex-wrap rounded-2.5xl bg-white p-10 dark:bg-jacarta-700 md:flex-nowrap md:space-x-8 md:p-[4.25rem] lg:space-x-16">
          ...
          <div className="mb-4 md:mb-0">
            <p className="text-lg leading-normal text-jacarta-700 dark:text-white">
              {
                "BadDogs is one of the most exciting, important companies in the world right now because it's the portal to the new digital economy. If you're interested in shaping a new business model for creators, this is the team to join."
              }
            </p>
