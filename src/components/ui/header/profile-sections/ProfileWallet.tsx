    ...
    <>
      ...
      <div className="flex justify-between">
        ...
        <SheetClose asChild>
          <button
            onClick={() => logOutAll()}
            className="w-[100px] font-display text-sm text-jacarta-700 dark:text-white text-center dark:hover:bg-jacarta-600 border border-gray-300 hover:bg-jacarta-50 flex items-center justify-center rounded-md"
